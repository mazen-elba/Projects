...
"""
Converts tracking_msgs/DetectedPersons into a geometry_msgs/PoseArray. This conversion is lossy,
...
rospy.loginfo("Re-publishing tracking_msgs/DetectedPersons from %s as geometry_msgs/PoseArray at %s" %
